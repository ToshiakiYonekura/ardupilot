...
MAV_RESULT GCS_MAVLINK_Copter::handle_command_int_packet(const mavlink_command_int_t &packet, const mavlink_message_t &msg)
{
    ...
    case MAV_CMD_NAV_LAND:
        // Mode 99: Landing is managed by Raspberry Pi via position commands
        // Normal LAND command will transition out of Mode 99 to LAND mode
    ...
    // Mode 99 (SmartPhoto99): State transitions managed by Raspberry Pi
    // No special MAVLink command handlers needed
